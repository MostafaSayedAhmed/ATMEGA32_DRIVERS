...
#define WAVEFORM_Timer0 CTC
#define WAVEFORM_Timer2 NORMAL_MODE
...
#define COMPARE_MATCH_Timer2    NORMAL_PORT
...
#define CLK_SEL_Timer0         EX_CLK_RISE_EDGE
#define CLK_SEL_Timer1         NO_PRE
#define CLK_SEL_Timer2         NO_PRE
